...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="assets/index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Trọ Tốt</b></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="assets/#">See All Messages</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="assets/#">View all</a></li>
            </ul>
          </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          {{-- <ul class="treeview-menu">
            <li class="active"><a href="assets/index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="assets/#"><i class="fa fa-circle-o"></i> Level One</a></li>
            <li class="treeview">
              <a href="assets/#"><i class="fa fa-circle-o"></i> Level One
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="assets/#"><i class="fa fa-circle-o"></i> Level Two</a></li>
                <li class="treeview">
                  <a href="assets/#"><i class="fa fa-circle-o"></i> Level Two
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
                  <ul class="treeview-menu">
                    <li><a href="assets/#"><i class="fa fa-circle-o"></i> Level Three</a></li>
                    <li><a href="assets/#"><i class="fa fa-circle-o"></i> Level Three</a></li>
                  </ul>
                </li>
              </ul>
        ...
        <li><a href="assets/https://adminlte.io/docs"><i class="fa fa-book"></i> <span>Documentation</span></a></li>
        <li class="header">LABELS</li>
        <li><a href="assets/#"><i class="fa fa-circle-o text-red"></i> <span>Important</span></a></li>
        <li><a href="assets/#"><i class="fa fa-circle-o text-yellow"></i> <span>Warning</span></a></li>
        <li><a href="assets/#"><i class="fa fa-circle-o text-aqua"></i> <span>Information</span></a></li> --}}
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              <li class="active"><a href="assets/#revenue-chart" data-toggle="tab">Area</a></li>
              <li><a href="assets/#sales-chart" data-toggle="tab">Donut</a></li>
            ...
            <div class="box-header">
              ...
              <div class="box-tools pull-right">
                <ul class="pagination pagination-sm inline">
                  <li><a href="assets/#">&laquo;</a></li>
                  <li><a href="assets/#">1</a></li>
                  <li><a href="assets/#">2</a></li>
                  <li><a href="assets/#">3</a></li>
                  <li><a href="assets/#">&raquo;</a></li>
                </ul>
              </div>
            </div>
            <!-- /.box-header -->
              ...
              <div class="pull-right box-tools">
                ...
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu pull-right" role="menu">
                    <li><a href="assets/#">Add new event</a></li>
                    <li><a href="assets/#">Clear events</a></li>
                    <li class="divider"></li>
                    <li><a href="assets/#">View calendar</a></li>
                  </ul>
                </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2016 <a href="assets/https://adminlte.io">Almsaeed Studio</a>.</strong> All rights
    reserved.
  </footer>
